...
class Embeddings(nn.Module):
    def __init__(self, d_model, K, o_dim, a_dim, num_actions, max_return, max_timestep, dropout):
        ...
        self.returns2go_emb = nn.Sequential(nn.Linear(1, 8), nn.Linear(8, d_model))
...
if __name__ == '__main__':
    ...
    negative_reward_offset = 100
    max_return = 200 + negative_reward_offset * max_timestep
        ...
        if (ep+1) % eval_freq == 0:
            ...
            with torch.no_grad():
                ...
                if mean_eval_return_cap < mean_eval_return:
                    ...
                    print('------------- max_return_gap: ', max_return - mean_eval_return_cap)
