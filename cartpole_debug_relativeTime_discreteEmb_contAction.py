...
class DecisionTransformer(nn.Module):
    def __init__(self, embeddings, encoder, d_model, num_actions, a_dim, seq_len, device):
        super().__init__()
...
def init_decision_transformer(d_model, d_k, d_v, d_ff, n_heads, n_layers, o_dim, a_dim, num_actions, max_return, max_timestep, K, dropout, device):
    ...
    model = DecisionTransformer(embeddings, encoder, d_model, num_actions, a_dim, seq_len, device)
