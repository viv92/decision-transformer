...
if __name__ == '__main__':
    ...
    eval_iters = 8 # so that mean_eval_return is a dependable value and not a high value by one-time fluke
    ...
    max_dataset_size = 8 # so that dataset is ridden of very old values / behaviours
    random_seed = 1010
