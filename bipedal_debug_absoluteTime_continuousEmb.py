...
class DecisionTransformer(nn.Module):
    ...
    def forward(self, states, actions, returns2go, timesteps, pad_mask=None): # shape: [batch_size, K, dim]
        ...
        action_scores = self.action_proj(out_actions) # action_scores.shape: [batch_size, K, a_dim]
            ...
            with torch.no_grad():
                ...
                for iter in range(eval_iters):
                    ...
                    while True:
                        ...
                        # action_scalar = [action_scalar] # required for pendulum env
